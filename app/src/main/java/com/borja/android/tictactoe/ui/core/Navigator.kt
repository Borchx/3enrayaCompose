package com.borja.android.tictactoe.ui.core
...
import com.borja.android.tictactoe.ui.core.Routes.*
import com.borja.android.tictactoe.ui.game.GameItem
    ...
    NavHost(
        ...
        composable(Game.route,
            arguments = listOf(
                ...
                navArgument("owner") { type = androidx.navigation.NavType.BoolType }
            )
        ) {
            GameScreen(
